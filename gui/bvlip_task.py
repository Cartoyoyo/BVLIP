...
class BvlipTask(QgsTask):
    ...
    # Fin : resultat du pipeline (ou None), message d'ereur (ou None).
    ...
    def run(self):  # noqa: A003 - nom impose par QgsTask
        ...
        try:
            ...
            # La trace part dans le message : sans elle, un echec dans une
            # tache de fond ne laisse rien d'exploitable.
