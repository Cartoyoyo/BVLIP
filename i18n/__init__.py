...
TR = {
    ...
    "view3d_html_network": {
        "fr": "Chevelu hydrographique", "en": "Stream network",
        "es": "Red hidrográfica", "pt": "Rede hidrográfica",
        "de": "Gewässernetz",
    },
    "view3d_html_crest": {
        "fr": "Ligne de partage des eaux", "en": "Watershed divide",
        "es": "Divisoria de aguas", "pt": "Divisor de águas",
        "de": "Wasserscheide",
    },
    "view3d_html_png": {
        "fr": "Image PNG", "en": "PNG image", "es": "Imagen PNG",
        "pt": "Imagem PNG", "de": "PNG-Bild",
    },
    "view3d_html_settings": {
        "fr": "Réglages", "en": "Settings", "es": "Ajustes",
        "pt": "Definições", "de": "Einstellungen",
    },
    "view3d_html_open": {
        ...
        "pt": "Página guardada:\n{path}\n\nAbri-la no navegador?",
        "de": "Seite gespeichert:\n{path}\n\nIm Browser öffnen?",
    },
    "view3d_habillage_ortho": {
        "fr": "Orthophoto (IGN)",
        "en": "Aerial photo (IGN)",
        "es": "Ortofoto (IGN)",
        "pt": "Ortofoto (IGN)",
    ...
    "view3d_export_mesh_tip": {
        "fr": "Maillage texturé pour Blender ou un visualiseur 3D, avec le chevelu et l'exutoire peints sur la texture.",
        "en": "Textured mesh for Blender or a 3D viewer, with streams and outlet painted on the texture.",
        "es": "Malla texturizada para Blender o un visor 3D, con la red y el punto de salida pintados en la textura.",
        "pt": "Malha texturizada para o Blender ou um visualizador 3D, com a rede e o exutório pintados na textura.",
        "de": "Texturiertes Netz für Blender oder einen 3D-Betrachter, Gewässer und Auslass auf die Textur gemalt.",
    },
    "view3d_export_html": {
        "fr": "Exporter la page 3D (.html)…",
        "en": "Export 3D page (.html)…",
        "es": "Exportar página 3D (.html)…",
        "pt": "Exportar página 3D (.html)…",
        "de": "3D-Seite exportieren (.html)…",
    },
    "view3d_export_html_tip": {
        "fr": "Un seul fichier qui s'ouvre dans n'importe quel navigateur, sans QGIS ni connexion : le bassin s'y tourne à la souris.",
        "en": "A single file that opens in any browser, without QGIS or a connection: the catchment rotates with the mouse.",
        "es": "Un solo archivo que se abre en cualquier navegador, sin QGIS ni conexión: la cuenca gira con el ratón.",
        "pt": "Um único ficheiro que abre em qualquer navegador, sem QGIS nem ligação: a bacia roda com o rato.",
        "de": "Eine einzige Datei für jeden Browser, ohne QGIS und ohne Verbindung: das Einzugsgebiet dreht sich mit der Maus.",
    },
    "view3d_export_working": {
        "fr": "Préparation de l'export…",
        "en": "Preparing export…",
        "es": "Preparando la exportación…",
        "pt": "A preparar a exportação…",
        "de": "Export wird vorbereitet…",
    },
    "view3d_html_title": {
        "fr": "Bassin versant en 3D",
        "en": "Catchment in 3D",
        "es": "Cuenca en 3D",
        "pt": "Bacia hidrográfica em 3D",
        "de": "Einzugsgebiet in 3D",
    },
    "view3d_html_subtitle": {
        "fr": "Altitudes de {low} à {high} m NGF · RGE ALTI® IGN · BVLIP",
        "en": "Elevations from {low} to {high} m NGF · RGE ALTI® IGN · BVLIP",
        "es": "Altitudes de {low} a {high} m NGF · RGE ALTI® IGN · BVLIP",
        "pt": "Altitudes de {low} a {high} m NGF · RGE ALTI® IGN · BVLIP",
        "de": "Höhen von {low} bis {high} m NGF · RGE ALTI® IGN · BVLIP",
    },
    "view3d_html_hint": {
        "fr": "Glisser pour tourner, clic droit ou Maj pour déplacer, molette pour zoomer.",
        "en": "Drag to rotate, right-click or Shift to pan, wheel to zoom.",
        "es": "Arrastrar para girar, clic derecho o Mayús para desplazar, rueda para ampliar.",
        "pt": "Arrastar para rodar, clique direito ou Shift para deslocar, roda para ampliar.",
        "de": "Ziehen zum Drehen, Rechtsklick oder Umschalt zum Verschieben, Rad zum Zoomen.",
    },
    "view3d_html_reset": {
        "fr": "Vue initiale",
        "en": "Reset view",
    ...
    "view3d_html_nowebgl": {
        "fr": "Ce navigateur ne sait pas afficher la 3D (WebGL).",
        "en": "This browser cannot display 3D (WebGL).",
        "es": "Este navegador no puede mostrar 3D (WebGL).",
        "pt": "Este navegador não consegue mostrar 3D (WebGL).",
        "de": "Dieser Browser kann kein 3D anzeigen (WebGL).",
    },
    "view3d_web_loading": {
        "fr": "Préparation de la vue web…",
        "en": "Preparing the web view…",
        "es": "Preparando la vista web…",
        "pt": "A preparar a vista web…",
        "de": "Webansicht wird vorbereitet…",
    },
    "preview_export": {
        "fr": "Exporter en PDF",
        "en": "Export to PDF",
